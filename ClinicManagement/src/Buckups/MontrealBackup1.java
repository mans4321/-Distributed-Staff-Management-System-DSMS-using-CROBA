...
public class MontrealBackup1 implements ApplyOperations {
    ...
    public MontrealBackup1 ()
    {
        this.serverName = "MontrealBackup1";
        this.database = new RecordManager();
        this.logger = new RmiLogger(serverName, "server");
        sendMessage = new SendMessage();
        sendMessage.setBackupPort1(50005);
        sendMessage.setBackupPort2(50045);
        // Failure  system 
        pingServers = new PingServers(new PingServerInfo(false , 50046 ) , 
        		new PingServerInfo(true , 50006 ), this, 50026, 50027 );
        
        this.manager = false;
        this.reliableFIFO = new ReliableFIFO(manager, 50025, 50005 , this);
        if(manager)
    ...
    public static void main(String []args){
    	MontrealBackup1 montreal = new MontrealBackup1();
    	}
    }