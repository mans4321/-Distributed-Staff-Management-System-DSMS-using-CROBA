...
public class DollardBackup2 implements ApplyOperations {
    ...
    public DollardBackup2 ()
    {
        this.serverName = "DollardBackup2";
        this.database = new RecordManager();
        this.logger = new RmiLogger(serverName, "server");
        sendMessage = new SendMessage();
        sendMessage.setBackupPort1(30005);
        sendMessage.setBackupPort2(30025);
        // Failure  system 
        pingServers = new PingServers(new PingServerInfo(true , 30006 ) , 
        		new PingServerInfo(false , 30026 ), this , 30046 , 30047 );
        this.manager = false;
        reliableFIFO = new ReliableFIFO(manager, 30045 ,30005   , this);
        if(manager)
...
public static void main(String []args){
	DollardBackup2 dollard = new DollardBackup2();    		
}
}