...
public class LavalBackup2 implements ApplyOperations {
    ...
    public LavalBackup2 ()
    {
        ...
        sendMessage.setBackupPort2(40025);
        // Failure  system 
        pingServers = new PingServers(new PingServerInfo(false ,40026) , 
        		new PingServerInfo(true ,40006 ), this, 40046 , 40047 );
        
        this.manager = false;
        this.reliableFIFO = new ReliableFIFO(manager,40045 ,40005 , this );
        if(manager)
    ...
    public static void main(String []args){
    	LavalBackup2 laval = new LavalBackup2();
    }
}