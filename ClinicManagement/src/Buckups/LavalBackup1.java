...
public class LavalBackup1 implements ApplyOperations {
    ...
    public LavalBackup1 ()
    {
        this.serverName = "LavalBackup1";
        this.database = new RecordManager();
        this.logger = new RmiLogger(serverName, "server");
        sendMessage = new SendMessage();
        sendMessage.setBackupPort1(40005);
        sendMessage.setBackupPort2(30045);
        // Failure  system 
        pingServers = new PingServers(new PingServerInfo(false , 40046 ) , 
        		new PingServerInfo(true , 40006 ), this, 30026  , 30027   );
        
        this.manager = false;
        reliableFIFO = new ReliableFIFO(manager, 40025, 40005 ,this );
        if(manager)
    ...
    public static void main(String []args){
    	LavalBackup1 laval = new LavalBackup1();
    }
}